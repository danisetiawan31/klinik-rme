...
// RespondError logs the raw error server-side with requestId and returns curated JSON to client.
...
// GlobalRecovery catches panics, logs stack traces server-side, and returns a formatted 500 error response.
