...
This project is indexed by GitNexus as **klinik-rme** (1788 symbols, 5214 relationships, 97 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
