...
This project is indexed by GitNexus as **klinik-rme** (2163 symbols, 5954 relationships, 121 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
