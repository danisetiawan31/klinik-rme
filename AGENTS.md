...
This project is indexed by GitNexus as **klinik-rme** (2154 symbols, 5940 relationships, 121 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
