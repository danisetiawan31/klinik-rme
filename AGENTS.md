...
This project is indexed by GitNexus as **klinik-rme** (1841 symbols, 5364 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
