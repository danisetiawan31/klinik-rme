...
This project is indexed by GitNexus as **klinik-rme** (1668 symbols, 4863 relationships, 86 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
