...
This project is indexed by GitNexus as **klinik-rme** (2243 symbols, 6116 relationships, 123 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
